...
function draw_graph_animation()
{
    ...
    for(let range in graph["r"])
    {
        ...
        graph_ctx.beginPath();
        graph_ctx.moveTo(graph_offset+range, graph_height-prev);
        graph_ctx.stroke();
        graph_ctx.closePath();
        prev = range;
    }
    ...
    graph_ctx.quadraticCurveTo(graph_offset+range, graph_height, graph_offset+range, graph_height-i, graph_offset+range+1, graph_height-i);
