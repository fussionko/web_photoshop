...
function filterData(img_data, filter_name)
{
    ...
    return history[current_filter_data["index"]-1];
}
...
function load_buttons(parent, controls)
{
    ...
    grayscale_avg.addEventListener("click", function(){
        clear(controls);
        loadImage(grayscale_average(filterData(img_data, "grayscale_avg")));
    });
    ...
    sharp.addEventListener("click", function(){
        clear(controls);
        loadImage(sharpening(changing_img_data), "sharpening");  
    });
    ...
    unsharp.addEventListener("click", function(){
        ...
        document.getElementById("unsharp-amount-controls").addEventListener("input", function(){
            loadImage(unsharpening(changing_img_data, parseFloat(this.value), parseInt(document.getElementById("unsharp-kernel-controls").value)), "unsharpening");  
        });
        document.getElementById("unsharp-kernel-controls").addEventListener("change", function(){
            loadImage(unsharpening(changing_img_data, parseFloat(document.getElementById("unsharp-amount-controls").value), parseInt(this.value)), "unsharpening");  
        });
    });
    ...
    weight_avg_lin.addEventListener("click", function(){
        ...
        document.getElementById("weighted_avg_linear-controls-weight").addEventListener("input", function(){
            loadImage(weighted_avg_linear(changing_img_data, parseInt(this.value)), "weighted_avg");  
        });
