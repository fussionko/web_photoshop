...
function load_buttons(parent, controls)
{
    ...
    channel_change.addEventListener("click", function(){
        ...
        sliders [i].addEventListener("input", () => {
            loadImage(color_channel_change(filterData(changing_img_data, "channel_change", "channel_remove"), parseInt(document.getElementById("color-channel-change-red").value), 
