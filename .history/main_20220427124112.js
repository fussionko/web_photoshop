...
let history = [1, 2, 5, 1 ,5 ,3 ,5, 64, 23, 2];
let currentHistoryIndex = 4;
...
{
    console.log(history.length-currentHistoryIndex-1);
    history.splice(currentHistoryIndex, history.length-currentHistoryIndex-1)
}
