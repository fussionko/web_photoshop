...
let canvas_x_position = main_canvas.getBoundingClientRect().left;
let canvas_y_position = main_canvas.getBoundingClientRect().right;
...
window.addEventListener("load", () => {
    ...
    console.log(main_canvas.getBoundingClientRect(), canvas_x_position, canvas_y_position);
