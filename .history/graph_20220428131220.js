...
function draw_graph()
{
    ...
    for(let range in graph["r"])
    {
        ...
        graph_ctx.beginPath();
        graph_ctx.moveTo(graph_offset+range, y);
        graph_ctx.strokeStyle = "#FF0000";
        graph_ctx.lineTo(range+graph_offset, y-graph["r"][range]);
        graph_ctx.stroke();
        graph_ctx.closePath();
        ...
        graph_ctx.lineTo(range+graph_offset, y-graph["g"][range]);
        graph_ctx.stroke();
        graph_ctx.closePath();
        ...
        graph_ctx.lineTo(range+graph_offset, y-graph["b"][range]);
        graph_ctx.stroke();
        graph_ctx.closePath();
    }
