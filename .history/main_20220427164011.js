...
window.addEventListener("load", () => {
    ...
    canvas_x_position = main_canvas.getBoundingClientRect().left;
    canvas_y_position = main_canvas.getBoundingClientRect().top;
    ...
    document.addEventListener('mouseup', function(e){
        ...
        if(e.clientY > canvas_y_position + canvas_height || e.clientX < canvas_y_position) return;
...
{
    if(e.clientX > canvas_x_position + canvas_width) pos.x = canvas_x_position + canvas_width;
    else if(e.clientX < canvas_x_position) pos.x = canvas_x_position;
    else pos.x = e.clientX - canvas_x_position;

    if(e.clientX > canvas_x_position + canvas_height) pos.y = canvas_y_position + canvas_height;
    else if(e.clientX < canvas_x_position) pos.y = canvas_y_position;
    else pos.y = e.clientY - canvas_y_position;
